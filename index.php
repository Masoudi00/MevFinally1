    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-light navbar-light pt-2 pb-2 fixed-top ">
            <div class="container-fluid ">
              <a class="navbar-brand ms-5 h1 " href="#"><img class="blacklogo" src="./uploads/BlackLogo.png" alt=""></a>
          ...
          <div class="row mt-5  ">
        <div class="d-flex flex-column col-1 mt-5 d-none d-md-none d-lg-block">
            <a href="https://www.linkedin.com/" target="blank" class="text-secondary"><div class="p-2 "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
              <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
            </svg>
              </div></a>
            <a href="https://www.instagram.com/masoudi00/" class="text-secondary">  <div class="p-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
             ...
             <a href="https://twitter.com/?lang=en" target="blank" class="text-secondary"> <div class="p-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
              <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
            </svg>
             </div></a> 
             <a href="https://www.facebook.com/" target="blank" class="text-secondary"><div class="p-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
              </svg>
             </div></a>       
        </div>
    <div class="css1 col-11" >
  <div class="text-center">
        <div class=" mt-5 h1 display-5 fw-bold font-weight-bold text-white">"Welcome"</div>
  </div>
    </div>
...
<div class="container-fluid text-center justify-content-lg-between "  id="Features">
    <h1 class="fw-bold mb-4 mt-5">"<span class="MEV">M</span>astering <span class="MEV">E</span>xcellence and <span class="MEV">V</span>ersatility"</h1>
    <p class="fw-bold text-secondary">"Features of our line and our exclusive services, Usability, Simplicity, Modesty, Fast-Shipping, Quality Prices, and more."</p>
    <p>.</p>     
    <div class="row d-flex justify-content-center">
      <div class="box col-lg-3 col-md-6 col-sm-12"><img class="img2" src="./uploads/WhiteLogo.png" alt="">
      ...
      <div class="detail-box text-white">
          <h5>
            Quality Prices &amp; Items
          </h5>
    
        </div></div>
    </div><br><br><br><br><br>
    <div class="container-fluid dd2" id="Contact Us">
  <div class="row justify-content-center justify-content-center">


  </div>
  <div class="container-fluid p-5 text-white ddd5" style="background-color:#000000; height:35%;">
